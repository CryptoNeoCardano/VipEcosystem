...
Module SQLSERVER_Add_Data
    ...
    Public Sub SQLSERVER_Add_Data1(Directory, Descrizione, Configurazione, Flusso, Diametro, Poli, Fasi, Tensione, Freq, coeff1, coeff2, coeff3, Tmin, Tmax, Qmin, Qmax, pow, Q, P, RPM, I, Numero_vel, Cat)
        ...
        Try
            ...
            Dim FStream_Datasheet As FileStream
            If nome_catalogo = "" Then
                FStream_Datasheet = New FileStream(Directory & "\" & Descrizione & ".pdf", FileMode.Open)
            Else
                FStream_Datasheet = New FileStream(Directory & "\" & nome_catalogo & "\" & Descrizione & ".pdf", FileMode.Open)
            End If
