...
Module PaginaA
    ...
    Public Sub PaginaA1()
        ...
        Report.XrPictureBox9.Visible = False
        Report.Label_ATX1.Visible = False
        Report.Label_ATX2.Visible = False
        Report.Label_ATX3.Visible = False
        Report.Label_ATX4.Visible = False
        Report.Label_ATX5.Visible = False

        'Visibilità note sul datasheet
        If testNote1 = Nothing Or Note_print = 0 Then
        ...
        End If
            ...
            'Eccezione ventilatore atex o unificato --> nascondo la connessione e anche la potenza assorbita
            If mod_fan = "U" Or mod_fan = "A" Then
            Report.Lb_motor.Text = ""
            Report.lb_motor1.Text = ""
            Report.lb_motor2.Text = ""
            Report.pto_bassa_conn.Visible = False
            Report.pto_alta_conn.Visible = False
            Report.XrTableCell332.Text = ""
            Report.XrTableCell300.Text = ""
            Report.pto1_conn_DELTA.Visible = False
            Report.pto2_conn_DELTA.Visible = False
            Report.pto3_conn_DELTA.Visible = False
            Report.pto1_conn_STAR.Visible = False
            Report.pto2_conn_STAR.Visible = False
            Report.pto3_conn_STAR.Visible = False
            Report.lb_pow.Text = ""
            Report.lb_pow1.Visible = False
            Report.lb_pow2.Visible = False
            Report.Pnom.Visible = True
            Report.Pnom.Text = "Pnom[W]"
        Else
            Report.Lb_motor.Text = "Conn."
            Report.lb_motor1.Text = "Conn."
            Report.lb_motor2.Text = "Conn."
            Report.pto_bassa_conn.Visible = True
            Report.pto_alta_conn.Visible = True
            Report.XrTableCell332.Text = "Conn."
            Report.XrTableCell300.Text = "-"
            Report.pto1_conn_DELTA.Visible = True
            Report.pto2_conn_DELTA.Visible = True
            Report.pto3_conn_DELTA.Visible = True
            Report.pto1_conn_STAR.Visible = True
            Report.pto2_conn_STAR.Visible = True
            Report.pto3_conn_STAR.Visible = True
            Report.lb_pow.Text = "Pnom [W]"
            Report.lb_pow1.Visible = True
        ...
        If mod_fan = "A" Then
            Report.XrPictureBox9.Visible = True
            Report.Label_ATX1.Visible = True
            Report.Label_ATX1.Text = "II"
            Report.Label_ATX2.Visible = True
            Report.Label_ATX2.Text = cbx_AtexProtezioneDS
            Report.Label_ATX3.Visible = True
            Report.Label_ATX3.Text = cbx_AtexCustodiaDS
            Report.Label_ATX4.Visible = True
            Report.Label_ATX4.Text = cbx_AtexCategoriaDS
            Report.Label_ATX5.Visible = True
            Report.Label_ATX5.Text = cbx_AtexClasseTemperaturaDS
        End If
