...
Module Variables
    ...
    Public modulo_PJ_PF As String = "H:\Passaggio\Paolo\Excel di lavoro\Moduli\Modulo di Progettazione Plug Fan.xlsm"
    ...
    Public Note_print As Integer = 0
    ...
    Public Catalogo_Filtro As String
    ...
    Public directory_test As String = "C:\Users\" & nome_macchina & "\Desktop\TEST MODELLI" & "\"
    ...
    Public TipoCestello As String
    Public Marca_motore As String
    ...
    Public Nome_colonne_SW_UNI(Numero_colonneDBtot) As String
    Public Numero_colonne_SW_UNI As Integer
