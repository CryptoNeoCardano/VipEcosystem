...
Module Servizio_mailing
    ...
    Public Sub listaPJ_utenti()
        ...
        Dim controllo_send As Integer = 0
        ...
        For o = 0 To numero_PJ_mail - 1
            If vettore_controllo_mail(o, 5) <> "" Then
                ...
                'se trovo anche solo una mail che è stata mandata "oggi" significa che il servizio mailing è già stato attivato
                If date_update = Today Then
                    controllo_send = 1
                End If
        ...
        If delta_date > 6 And today_day = DayOfWeek.Monday And controllo_send = 0 Then
