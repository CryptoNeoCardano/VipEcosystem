...
Public Class ArchivioDS
    ...
    Private Sub ArchivioDS_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: questa riga di codice carica i dati nella tabella 'NewPJDataSet1.Catalogo'. È possibile spostarla o rimuoverla se necessario.
        Me.CatalogoTableAdapter.Fill(Me.NewPJDataSet1.Catalogo)
        ...
        If nome_macchina = "Lorenzo" Or nome_macchina = "Davide" Then
        ...
        Dim LeggiCatalogo As New ReadSeriesCatalogo()
        LeggiCatalogo.Main(Filtro_Catalogo)
    ...
    Private Sub Guna2DataGridView1_CellContentDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles Guna2DataGridView1.CellDoubleClick
        ...
        If nome_macchina = "Lorenzo" Or nome_macchina = "Stefano" Or nome_macchina = "Paolo" Or nome_macchina = "Fausto" Or nome_macchina = "Alberto" Or nome_macchina = "LAPTOP-BB6VDD4D" Or nome_macchina = "Davide" Then
    ...
    Public Sub load_datasheet(Nome_DS)
        ...
        'Elimina i warning dovuti agli effetti grafici
        ...
        Label22.Location = New System.Drawing.Point(738, 550)
    ...
    Public Sub ricerca_DB()
        ...
        For i As Integer = 0 To numero_DS - 1
            ...
            cat1 = DS_totale_dati(i, 88)
            cat2 = DS_totale_dati(i, 89)
            cat3 = DS_totale_dati(i, 90)
            cat4 = DS_totale_dati(i, 91)
            cat5 = DS_totale_dati(i, 92)
            ...
            Catalogo_Filtro = Filtro_catalogo.SelectedItem

            Tmin = DS_lista(i, 11)
            Tmax = DS_lista(i, 10)


            If (Filtro_Motore.SelectedIndex < 1 Or Motore_Filtro(0) = Tipo_motore) And (Filtro_Serie.SelectedIndex < 1 Or Serie_Filtro(0) = Tipo_ventilatore) _
                And (Filtro_Profilo.SelectedIndex < 1 Or Profilo_Filtro(0) = Profilo_pala) And (Filtro_Pale.SelectedIndex < 1 Or Pale_Filtro(0) = Npale) And
                (Filtro_Diametro.SelectedIndex < 1 Or Diametro_Filtro(0) = diametro) And (Filtro_Calettamento.SelectedIndex < 1 Or Calettamento_Filtro(0) = calettamento) _
                And (Filtro_Tensione.SelectedIndex < 1 Or Tensione_Filtro(0) = tensione) And (Filtro_Frequenza.SelectedIndex < 1 Or Frequenza_Filtro(0) = frequenza) And
                (Filtro_Poli.SelectedIndex < 1 Or Poli_Filtro(0) = poli) And (Tipo_provaDS = Prova_Filtro Or Filtro_Prova.SelectedIndex = 0) And
                ((cat1 = Catalogo_Filtro Or cat2 = Catalogo_Filtro Or cat3 = Catalogo_Filtro Or cat4 = Catalogo_Filtro Or cat5 = Catalogo_Filtro) Or Filtro_Catalogo.SelectedIndex < 1) Then
    ...
    Public Sub Procedura_rigenera_DS()
        ...
        Guna2Panel2.BringToFront()  '------> ESEGUIRE IN PARALLELO
        Label22.Text = ""
        Label22.Location = New System.Drawing.Point(500, 550)

        Guna2PictureBox1.Image = My.Resources.Uploading
        Application.DoEvents()

        Datasheet_print_mode = 1

        Dim taskA As Task = Task.Run(Sub() load_datasheet(0))
    ...
    Private Sub Filtro_Catalogo_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Filtro_Catalogo.SelectedIndexChanged
        Try
            Filtro_Prova.SelectedIndex = 0
            ricerca_DB()
        Catch ex As Exception
